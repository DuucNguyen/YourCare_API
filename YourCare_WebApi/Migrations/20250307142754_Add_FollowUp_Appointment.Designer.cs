...
namespace YourCare_WebApi.Migrations
{
    ...
    [Migration("20250307142754_Add_FollowUp_Appointment")]
    partial class Add_FollowUp_Appointment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YourCare_BOs.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("YourCare_BOs.AppointmentFilesUpload", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppointmentFilesUpload", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("YourCare_BOs.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YourCare_BOs.AppointmentFilesUpload", b =>
                {
                    b.HasOne("YourCare_BOs.Appointment", "Appointment")
                        .WithMany("Files")
